...
class TestNexusSearchService(TestUnitBase):
    ...
    def test_get_services_master_version_success(self):
        ...
        self.nexus_search_service.get_services_master_version(self._repo, ms_list)
    ...
    def test_get_services_master_version_without_items(self):
        ...
        self.nexus_search_service.get_services_master_version(self._repo, [service_data])
    ...
    def test_get_services_master_version_empty_input(self, filtered_list):
        self.nexus_search_service.get_services_master_version(self._repo, filtered_list)
    ...
    def test_get_services_master_version_missing_version(self):
        ...
        self.nexus_search_service.get_services_master_version(self._repo,
                                                                             [service_data])
        self.mock_nexus_search.assert_called()
        self.assertIsNotNone(service_data)
        self.assertIsNone(service_data.to_version)
