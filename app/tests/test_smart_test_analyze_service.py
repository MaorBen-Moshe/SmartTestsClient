...
class TestHandleGroupsDataStepUnit(TestUnitBase):
    ...
    def test_get_all_flows_by_filter_success(self):
        ...
        mat_groups_data = groups_data.get_group("mat_APIGW_testng.xml")
        ...
        b2b_groups_data = groups_data.get_group("extended_mat_7b_APIGW_testng.xml")
    ...
    def test_get_all_flows_by_filter_emtpy_group_filter(self):
        ...
        unknown_groups_data = groups_data.get_group("unknown-group")
    ...
    def test_analyze_flows_success(self):
        ...
        self.assertEqual(groups_data.get_group("group1").curr_flows_count, 3)
        self.assertListEqual(groups_data.get_group("group1").flows, ["flow1", "flow2", "flow3"])
        self.assertEqual(groups_data.get_group("group2").curr_flows_count, 2)
        self.assertListEqual(groups_data.get_group("group2").flows, ["flow1", "flow2"])
