...
class TestEndpoints(TestBase):
    ...
    def test_supported_groups_endpoint_success(self):
        res = self.client_feature.get("/supported-groups")
    ...
    def test_smart_tests_analyze_endpoint_success(self):
        ...
        res = self.client_feature.post("/smart-tests-analyze", json=data, content_type='application/json')
        assert res.status_code == 200

    def test_smart_tests_analyze_endpoint_missing_payload(self):
        res = self.client_feature.post("/smart-tests-analyze", content_type='application/json')
